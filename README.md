This is a fork of the OpenLayers - Cesium integration library to show the following example of a strange shadow seen using WKTs (polygons) drawn in the map:
